...
public class AlumnoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (opcion) {
            case 1 -> out.println(alumnoDao.readAllAlumno());
            case 2 -> out.println(alumnoDao.readAllAlumno());
            case 3 -> out.println(alumnoDao.readAllAlumno());
            case 4 -> out.println(alumnoDao.readAllAlumno());
            case 5 -> out.println(alumnoDao.readAllAlumno());
